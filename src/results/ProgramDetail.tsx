    ...
    <div className="h-full overflow-y-auto bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-2 mb-2 text-sm">
          <Link to="/results" className="text-blue-600 hover:text-blue-800 font-medium flex items-center gap-1">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            მთავარი
          </Link>
          <span className="text-gray-300">/</span>
          <Link to={`/results/${year}/uni/${uniCode}`} className="text-blue-600 hover:text-blue-800 hover:underline truncate max-w-[300px]">
            {uniName}
          </Link>
          <span className="text-gray-300">|</span>
