...
export const COLUMNS: ColumnDef[] = [
  ...
  // raw + scaled are merged into one cell ("ნედლი → სკალირებული"); sort by the scaled value
  { key: "geoScaled", label: "ქართული (ნედლი → სკალ.)", shortLabel: "ქართ.", defaultVisible: true, sortable: true, numeric: true, width: 100 },
  { key: "langName", label: "უცხო ენა", defaultVisible: true, sortable: true, numeric: false, width: 110 },
  { key: "langScaled", label: "უცხო ენა (ნედლი → სკალ.)", shortLabel: "უცხ.", defaultVisible: true, sortable: true, numeric: true, width: 100 },
  { key: "sub1Name", label: "არჩევითი 1", defaultVisible: true, sortable: true, numeric: false, width: 110 },
  { key: "sub1Scaled", label: "არჩ. 1 (ნედლი → სკალ.)", shortLabel: "არჩ.1", defaultVisible: true, sortable: true, numeric: true, width: 100 },
  { key: "sub2Name", label: "არჩევითი 2", defaultVisible: false, sortable: true, numeric: false, width: 100 },
  { key: "sub2Scaled", label: "არჩ. 2 (ნედლი → სკალ.)", shortLabel: "არჩ.2", defaultVisible: false, sortable: true, numeric: true, width: 100 },
