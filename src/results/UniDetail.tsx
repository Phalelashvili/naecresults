    ...
    <div className="h-full overflow-y-auto bg-gray-50">
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-3 mb-2">
          <Link to="/results" className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
              ...
              {programs.map((p) => {
                ...
                return (
                  <tr key={p.progCode} className={`border-t border-gray-100 hover:bg-gray-50 ${isFav ? "bg-yellow-50" : ""}`}>
                    ...
                    <td className="px-4 py-2">
                      <Link to={`/results/${year}/program/${p.progCode}`} className="font-medium text-blue-600 hover:text-blue-800 hover:underline">
                        {p.name}
                      </Link>
                    </td>
