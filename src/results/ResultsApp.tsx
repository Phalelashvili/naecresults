...
export default function App() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center results-root">
    ...
    <div className="results-root flex flex-col overflow-hidden">
      ...
      <Routes>
        <Route index element={
          <>
            {/* Filter bar */}
            <div className="results-filterbar shrink-0">
            ...
            {/* Table + list panel */}
            <div className="results-tablearea flex flex-1 overflow-hidden">
              <div className="results-table flex-1 overflow-hidden">
                <DataTable
